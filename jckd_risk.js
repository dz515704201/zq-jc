...
需要用到jc_cookie，只测试了青龙，理论上V2P也能用
本脚本没有设置重写，请自己复制jc_cookie到青龙环境下使用，多账号用@隔开
例子： export jc_cookie='uid=xxx&zqkey=yyy&zqkey_id=zzz@uid=aaa&zqkey=bbb&zqkey_id=ccc@uid=qqq&zqkey=sss&zqkey_id=ttt'
*/
...
let userCookie = ($.isNode() ? process.env.jc_cookie : $.getdata('jc_cookie')) || '';
let userCookieArr = []
